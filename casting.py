...
object oriented language, and aS such it uses classes to define data types, including it primitive types.
"""

# Casting in Python is therefore done using constructor functions.

"""
"int()" -constructs an integer number from an integer literal, a float literal(by rounding down the previous 
